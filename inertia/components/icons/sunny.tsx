export default function SunnyIcon(props: any) {
  const fillColor = props.fillColor || '#F0C419'
  const fillColorSecondary = props.fillColorSecondary || '#EDE21B'
  const style = {
    fill: fillColor,
  }
  ...
  return (
    ...
    >
      ...
      <g id="SVGRepo_iconCarrier">
        ...
        <circle style={style} cx="30" cy="30" r="20"></circle>{' '}
        <circle style={{ fill: fillColorSecondary }} cx="30" cy="30" r="15"></circle>{' '}
      </g>
    </svg>
  )
}
